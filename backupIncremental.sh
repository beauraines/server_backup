...
#rsync -Hpavxhr --exclude-from=/usr/local/bin/backupExcludes_home --compare-dest=$BACKUP_DIR/../$LASTFULLBACKUP/ /Users $BACKUP_DIR >> $BACKUP_DIR/log/backup_$DATES.log 2>&1
#rcCheck $?
#echo "done."
